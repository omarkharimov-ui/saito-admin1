...
export function CampaignsSkeleton() {
  return (
    ...
    >
      ...
      <div>
        <div className="h-5 w-32 bg-white/[0.05] rounded mb-4" />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              ...
              <div className="h-16 bg-white/[0.05] rounded-lg" />
      ...
      {/* Inactive Campaigns */}
      <div>
        <div className="h-5 w-36 bg-white/[0.05] rounded mb-4" />
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {Array.from({ length: 2 }).map((_, i) => (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="h-5 w-18 bg-white/[0.08] rounded-full" />
              </div>
              <div className="h-16 bg-white/[0.05] rounded-lg" />
            </motion.div>
          ))}
