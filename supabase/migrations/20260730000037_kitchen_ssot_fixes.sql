-- ============================================================================
-- FIX 37: Kitchen SSOT fixes — accept_order_atomic + mark_ready update
-- ============================================================================

-- accept_order_atomic: accept order, assign staff, transition items to preparing
...
-- mark_ready_atomic: add optional completion flag
