-- activate_table_atomic: activate reserved table, create order, assign to guest
...
BEGIN
  ...
  INSERT INTO public.operation_logs (
    table_number, order_id, reservation_id, action, old_values, new_values
  ) VALUES (
    v_table.table_number, v_order_id, v_reservation.id, 'activate_table',
