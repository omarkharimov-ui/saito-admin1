...
GRANT ALL ON FUNCTION public.log_operation(text, uuid, integer, integer, jsonb, jsonb, jsonb, uuid, text, text, text, text) TO anon;

GRANT ALL ON FUNCTION public.log_operation(text, uuid, integer, integer, jsonb, jsonb, jsonb, uuid, text, text, text, text) TO authenticated;
