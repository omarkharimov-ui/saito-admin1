CREATE FUNCTION public.merge_reservation_tables_atomic (
...
GRANT ALL ON FUNCTION public.merge_reservation_tables_atomic(uuid, integer[], uuid) TO anon;

GRANT ALL ON FUNCTION public.merge_reservation_tables_atomic(uuid, integer[], uuid) TO authenticated;

GRANT ALL ON FUNCTION public.merge_reservation_tables_atomic(uuid, integer[], uuid) TO service_role;