-- Fix create_delivery_order RPC: set order_type, validate input, restrict grants
...
REVOKE ALL ON FUNCTION public.create_delivery_order(text, text, text, text, text, text, text, text, text, text, text, numeric, timestamp WITH time zone, jsonb, uuid) FROM anon;
REVOKE ALL ON FUNCTION public.create_delivery_order(text, text, text, text, text, text, text, text, text, text, text, numeric, timestamp WITH time zone, jsonb, uuid) FROM authenticated;
