CREATE FUNCTION public.cancel_ticket_atomic (
  p_order_id                 uuid,
...
GRANT ALL ON FUNCTION public.cancel_ticket_atomic(uuid, text, uuid, text) TO anon;

GRANT ALL ON FUNCTION public.cancel_ticket_atomic(uuid, text, uuid, text) TO authenticated;

GRANT ALL ON FUNCTION public.cancel_ticket_atomic(uuid, text, uuid, text) TO service_role;