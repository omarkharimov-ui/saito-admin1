...
export default function RolesPage() {
  ...
  // P-1 M6 (retired 2026-09-12): the per-location "override" tables +
  // /api/permissions/overrides were dead (0 rows, never consulted by the
  // has_permission gate, broken writer). The location-override UI is removed;
  // location scope is enforced at the financial-write layer instead.
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2">
          {!selectedRole ? (
            ...
            >
              ...
              <div className="p-6 border-b border-[var(--theme-border)]">
               ...
               {/* P-1 M6: view toggle removed — only the permissions view remains */}
          ...
          {/* P-1 M6: Location Overrides panel removed (dead override tables retired 2026-09-12) */}
        </div>
      </div>
