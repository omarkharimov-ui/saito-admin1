...
const ReservationLoadingSpinner = () => {
  ...
  return (
    <div className="flex items-center justify-center py-20" style={{ position: 'relative' }}>
      <motion.div
      ...
      <motion.div animate={{ scale: [1, 1.055, 1] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} style={{ width: sz, height: sz }}>
        <svg width={sz} height={sz} viewBox={`0 0 ${sz} ${sz}`} style={{ overflow: 'visible' }}>
          ...
          <motion.circle cx={R} cy={R} r={r1} fill="none" stroke="url(#gsRes1)" strokeWidth="2.2" strokeLinecap="round"
          ...
          <motion.circle cx={R} cy={R} r={r2} fill="none" stroke="url(#gsRes2)" strokeWidth="1.8" strokeLinecap="round"
