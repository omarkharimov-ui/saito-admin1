    ...
    <div className="rounded-xl border border-purple-500/15 bg-purple-500/[0.03] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-purple-500/10">
        ...
        {error && !manualMode && (
          <div className="flex items-center gap-1.5">
            <button
              onClick={onRetry}
              className="px-2 py-1 rounded-lg text-[10px] font-bold text-purple-300 bg-purple-500/10 hover:bg-purple-500/20 transition-all"
            >
              Təkrar cəhd
            </button>
            <button
              onClick={onManualEnter}
              className="px-2 py-1 rounded-lg text-[10px] font-bold text-blue-300 bg-blue-500/10 hover:bg-blue-500/20 transition-all"
            >
              Əl ilə daxil et
            </button>
          </div>
      ...
      <AnimatePresence mode="wait">
        {loading && (
          ...
          >
            <div className="h-4 rounded-lg bg-purple-500/10 animate-pulse w-3/4" />
            <div className="h-4 rounded-lg bg-purple-500/8 animate-pulse w-1/2" />
            <div className="h-4 rounded-lg bg-purple-500/6 animate-pulse w-2/3" />
          </motion.div>
        )}
        ...
        {manualMode && (
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[10px] font-bold uppercase tracking-wider text-blue-400/60">
