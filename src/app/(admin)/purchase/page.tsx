...
import { InvoiceDropzone, type OCRResult, type OCRLine } from './components/InvoiceDropzone';
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-white">Tədarük / Faktura</h1>
      ...
      {/* Dropzone */}
      {!ocrResult && (
        <InvoiceDropzone onParsed={handleParsed} />
      )}
