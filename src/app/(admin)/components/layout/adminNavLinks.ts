...
export function getAdminNavItems(
  ...
  return [
    ...
    { id: 'suppliers', name: 'Tədarükçülər', href: '/suppliers', icon: Truck, roles: ['superadmin'] },
    { id: 'purchase-orders', name: 'Alış Sifarişləri', href: '/purchase-orders', icon: ShoppingCart, roles: ['superadmin'] },
    { id: 'receiving', name: 'Tədarük Qəbulu', href: '/receiving', icon: PackageCheck, roles: ['superadmin'] },
    { id: 'reconciliation', name: 'Faktura', href: '/reconciliation', icon: FileText, roles: ['superadmin'] },
    { id: 'discrepancies', name: 'Uyğunsuzluqlar', href: '/discrepancies', icon: AlertTriangle, roles: ['superadmin'] },
    { id: 'stock-suggestions', name: 'Stok Təklifləri', href: '/stock-suggestions', icon: Lightbulb, roles: ['superadmin'] },
    { id: 'recipe-intelligence', name: 'Resept İntellekti', href: '/recipe-intelligence', icon: ChefHat, roles: ['superadmin'] },
