-- void_order_item_atomic: void an order item, restore inventory if needed
...
BEGIN
  ...
  -- Rollback inventory if it was already deducted
  FOR v_tx IN 
  ...
  INSERT INTO public.operation_logs (
    ...
    jsonb_build_object('item_id', p_order_item_id, 'kitchen_status', 'cancelled', 'reason', p_reason),
    p_performed_by
  );
