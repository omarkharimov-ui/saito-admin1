-- Fix create_delivery_order RPC to set order_type and accept structured address
...
GRANT ALL ON FUNCTION public.create_delivery_order(text, text, text, text, text, text, text, text, text, text, text, numeric, timestamp WITH time zone, jsonb, uuid) TO anon;
GRANT ALL ON FUNCTION public.create_delivery_order(text, text, text, text, text, text, text, text, text, text, text, numeric, timestamp WITH time zone, jsonb, uuid) TO authenticated;
