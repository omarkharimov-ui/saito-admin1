      ...
      {open && (
        <>
          ...
          <motion.div {...appleCard} transition={fastExit} className="fixed inset-0 z-[160] flex items-center justify-center p-4 pointer-events-none">
            <div className={`border ${lightMode ? 'bg-white border-zinc-200' : 'bg-zinc-900 border-white/10'} rounded-6xl w-full max-w-xl max-h-[85vh] overflow-hidden shadow-elevated backdrop-blur-lg flex flex-col pointer-events-auto`}>
              {/* Header */}
