CREATE FUNCTION public.mark_served_atomic (
  p_order_id                 uuid,
...
GRANT ALL ON FUNCTION public.mark_served_atomic(uuid, uuid, text) TO anon;

GRANT ALL ON FUNCTION public.mark_served_atomic(uuid, uuid, text) TO authenticated;

GRANT ALL ON FUNCTION public.mark_served_atomic(uuid, uuid, text) TO service_role;