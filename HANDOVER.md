...
Payment core (D-6/D-7) · merge/unmerge/transfer V2 contracts · D-2/D-5 location propagation · inventory consume/waste · agg/reconciler trigger · Z-report · auth core · order state machine · **Total SSOT engine (calculate_order_total_v3 + 20260910000004)** · **Outbox consumer (outbox_pump/outbox_dispatch) + pg_cron scheduler** (A#1) · **🔒 A — AUTHENTICATION/RBAC** (2026-09-11, `d84c20e`, 39/39 regression; açma şərti: real security vuln / data corruption / regression / frozen-contract səhvi — `AUDIT_A_FREEZE.md`).
