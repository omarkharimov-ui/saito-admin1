...
-- ═══════════════════════════════════════════════════════════════
-- 17. ORDERS — order_type (dine_in / takeaway / delivery)
-- ═══════════════════════════════════════════════════════════════
ALTER TABLE orders ADD COLUMN IF NOT EXISTS order_type text DEFAULT 'dine_in';

-- ═══════════════════════════════════════════════════════════════
-- 18. CUSTOMERS table + customer_id on orders
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 19. CLOCK_EVENTS table (employee clock in/out)
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 20. ORDER_ITEMS — course column (e.g. 'main', 'dessert', 'drink')
-- ═══════════════════════════════════════════════════════════════
ALTER TABLE order_items ADD COLUMN IF NOT EXISTS course text DEFAULT 'main';

-- ═══════════════════════════════════════════════════════════════
-- 21. ORDERS — guest_count & tip_amount
-- ═══════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════
-- 22. TABLE_FLOORS — floor/zone assignments per table
-- ═══════════════════════════════════════════════════════════════
...
SELECT 'migration v5 completed' AS status;
