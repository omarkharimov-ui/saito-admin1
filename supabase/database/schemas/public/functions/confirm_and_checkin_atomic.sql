CREATE FUNCTION public.confirm_and_checkin_atomic (
...
GRANT ALL ON FUNCTION public.confirm_and_checkin_atomic(uuid, integer[], uuid) TO anon;

GRANT ALL ON FUNCTION public.confirm_and_checkin_atomic(uuid, integer[], uuid) TO authenticated;
