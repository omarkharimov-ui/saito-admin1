...
const actions = [
  ...
  { id: 'close_bill', icon: CreditCard, label: 'Hesab', color: 'text-gold', bg: 'bg-gold/10', border: 'border-gold/20', lightColor: 'text-gold', lightBg: 'bg-gold/10', lightBorder: 'border-gold/20' },
