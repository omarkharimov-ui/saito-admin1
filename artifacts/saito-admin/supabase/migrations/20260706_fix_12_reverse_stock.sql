-- ============================================================================
-- Fix 12: Create reverse_stock_deduction RPC (called from cancel/route.ts
-- but was never defined)
-- ============================================================================

-- When an unpaid order is cancelled, any order_consumption inventory_log entries
-- must be reversed: stock is added back to ingredients, and a reversal log is
