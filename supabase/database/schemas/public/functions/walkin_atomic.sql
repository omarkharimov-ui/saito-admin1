CREATE FUNCTION public.walkin_atomic (
...
GRANT ALL ON FUNCTION public.walkin_atomic(integer, integer, text, text, text, uuid) TO anon;

GRANT ALL ON FUNCTION public.walkin_atomic(integer, integer, text, text, text, uuid) TO authenticated;
