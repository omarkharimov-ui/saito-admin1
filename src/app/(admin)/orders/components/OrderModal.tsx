        ...
        <div className="px-5 pt-2 pb-0 flex items-center justify-between flex-shrink-0 min-h-[48px]">
          <div className="flex items-center gap-3 min-w-0">
            ...
            {order.order_type && order.order_type !== 'dine_in' && (
              <span className={`text-[9px] font-semibold px-1.5 py-0.5 rounded-full flex items-center gap-1 ${order.order_type === 'takeaway' ? 'text-amber-400/70 bg-amber-500/10 border border-amber-500/20' : 'text-slate-300/80 bg-slate-500/10 border border-slate-500/20'}`}>
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {(() => {
              ...
              if (ks === 'preparing' || ks === 'cooking') return <span className="text-[9px] font-black px-2 py-1 rounded-full tracking-wider uppercase bg-slate-500/15 text-slate-300 border border-slate-500/30">{t('badge_preparing')}</span>;
