...
REVOKE ALL ON FUNCTION public.validate_transition(text, text, text) FROM anon;
REVOKE ALL ON FUNCTION public.validate_transition(text, text, text) FROM authenticated;
