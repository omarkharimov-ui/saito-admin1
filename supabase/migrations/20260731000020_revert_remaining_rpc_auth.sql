-- Revert auth checks in remaining SECURITY DEFINER RPCs
-- These were incorrectly modified in migration 20260731000009.
...
REVOKE ALL ON FUNCTION public.complete_payment_v4(uuid, text, numeric, numeric, numeric, numeric) FROM anon;
REVOKE ALL ON FUNCTION public.complete_payment_v4(uuid, text, numeric, numeric, numeric, numeric) FROM authenticated;
...
GRANT ALL ON FUNCTION public.walkin_atomic(integer, integer, text, text, text, uuid) TO service_role;
REVOKE ALL ON FUNCTION public.walkin_atomic(integer, integer, text, text, text, uuid) FROM anon;
REVOKE ALL ON FUNCTION public.walkin_atomic(integer, integer, text, text, text, uuid) FROM authenticated;
...
REVOKE ALL ON FUNCTION public.reserve_table_atomic(uuid, uuid[], integer, jsonb, uuid) FROM anon;
REVOKE ALL ON FUNCTION public.reserve_table_atomic(uuid, uuid[], integer, jsonb, uuid) FROM authenticated;
...
REVOKE ALL ON FUNCTION public.process_order_payment(uuid, text, numeric, numeric, uuid, numeric, text, uuid, numeric, numeric) FROM anon;
REVOKE ALL ON FUNCTION public.process_order_payment(uuid, text, numeric, numeric, uuid, numeric, text, uuid, numeric, numeric) FROM authenticated;
