CREATE FUNCTION public.waste_order_item_atomic (
  p_order_item_id            uuid,
  p_reason                   text DEFAULT 'waste'::text,
...
GRANT ALL ON FUNCTION public.waste_order_item_atomic(uuid, text, uuid, text) TO anon;

GRANT ALL ON FUNCTION public.waste_order_item_atomic(uuid, text, uuid, text) TO authenticated;

GRANT ALL ON FUNCTION public.waste_order_item_atomic(uuid, text, uuid, text) TO service_role;