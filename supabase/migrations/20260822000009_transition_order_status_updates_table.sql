-- Update transition_order_status to also update table_floors status atomically
-- This ensures table state stays in sync with order state without frontend mutations
...
BEGIN
  ...
  -- 5. Update table_floors status for dine-in orders
