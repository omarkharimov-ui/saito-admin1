...
export function getAdminNavItems(
  ...
  return [
    ...
    { id: 'orders', name: 'Sifarişlər', href: '/admin/orders', icon: ShoppingBag, roles: ['admin', 'superadmin'] },
    { id: 'kds', name: 'Mətbəx', href: '/admin/kds', icon: ChefHat, roles: ['admin', 'superadmin'] },
